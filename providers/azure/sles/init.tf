data "template_file" "register_rmt" {
  template = file("${path.module}/init/register-rmt.tpl")
...
data "template_file" "register_scc" {
  ...
  template = file("${path.module}/init/register-scc.tpl")
...
data "template_file" "register_suma" {
  template = file("${path.module}/init/register-suma.tpl")
...
data "template_file" "repositories" {
  ...
  template = file("${path.module}/init/repository.tpl")
...
data "template_file" "ntp_servers" {
  ...
  template = file("${path.module}/init/ntp.tpl")
...
data "template_file" "dns_nameservers" {
  ...
  template = file("${path.module}/init/nameserver.tpl")
...
data "template_file" "commands" {
  ...
  template = file("${path.module}/init/commands.tpl")
...
data "template_file" "cloud-init" {
  template = file("${path.module}/init/init.sh.tpl")
