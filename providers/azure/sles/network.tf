...
#   count               = var.create_bastionhost ? 0 : var.etcds
#   name                = "${var.stack_name}-etcd-${count.index}-ip"
#   location            = azurerm_resource_group.resource_group.location
#   resource_group_name = azurerm_resource_group.resource_group.name
#   allocation_method   = "Static"
#   sku                 = "Standard"
...
#   count               = var.create_bastionhost ? 0 : var.storages
#   name                = "${var.stack_name}-storage-${count.index}-ip"
#   location            = azurerm_resource_group.resource_group.location
#   resource_group_name = azurerm_resource_group.resource_group.name
#   allocation_method   = "Static"
#   sku                 = "Standard"
