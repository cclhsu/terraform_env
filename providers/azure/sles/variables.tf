...
variable "etcd_use_spot_instance" {
  type        = bool
  default     = false
  description = "Use spot instances for etcd nodes"
}

variable "etcd_vm_size" {
  type        = string
  default     = "Standard_D2s_v3"
  description = "Virtual machine size of the etcd nodes"
}

variable "etcd_storage_account_type" {
  type        = string
...
variable "storage_use_spot_instance" {
  type        = bool
  default     = false
  description = "Use spot instances for storage nodes"
}

variable "storage_vm_size" {
  type        = string
  default     = "Standard_D2s_v3"
  description = "Virtual machine size of the storage nodes"
}

variable "storage_storage_account_type" {
  type        = string
  default     = "Standard_LRS"
  description = "Storage account type"
}
