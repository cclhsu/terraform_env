...
locals {
  aws_iam_instance_profile_etcd_terraform    = "${var.stack_name}_cpi_etcd"
  aws_iam_instance_profile_storage_terraform = "${var.stack_name}_cpi_storage"
  aws_iam_instance_profile_master_terraform  = "${var.stack_name}_cpi_master"
  aws_iam_instance_profile_worker_terraform  = "${var.stack_name}_cpi_worker"
}

resource "aws_iam_instance_profile" "etcd" {
  count = length(var.iam_profile_etcd) == 0 ? 1 : 0
  name  = local.aws_iam_instance_profile_etcd_terraform
...
resource "aws_iam_instance_profile" "storage" {
  ...
  name  = local.aws_iam_instance_profile_storage_terraform
