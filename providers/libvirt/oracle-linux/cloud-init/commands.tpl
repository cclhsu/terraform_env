  ...
  - /usr/bin/sed -i 's/#PasswordAuthentication .*/PasswordAuthentication yes/g' /etc/ssh/sshd_config
  ...
  - /usr/bin/mkdir -p /etc/iscsi
  - /usr/bin/echo "InitiatorName=$(/sbin/iscsi-iname)" > /etc/iscsi/initiatorname.iscsi
